...
public class Navigation {
  ...
  private void transformAndAim(
      Triplet<Double, Double, Double> direction, ReferenceFrame referenceFrame)
      throws RPCException {
    aimAtDirection(transformDirection(direction, referenceFrame));
  }

  // Método auxiliar sobrecarregado para clareza
  private Triplet<Double, Double, Double> transformDirection(
      Triplet<Double, Double, Double> direction, ReferenceFrame fromReference) throws RPCException {
