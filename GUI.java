...
public class GUI extends JFrame implements ActionListener {
	...
	static final String parametros = "Parâmetros";
	static final String decolagemOrbital = "Decolagem Orbital";
	static final String suicideBurn = "Suicide Burn";
	static final String autoRover = "Auto Rover";
	static final String manobras = "Manobras";
	static final String conectar = "Conectar";
	static final String iniciar = "Iniciar";
	static final String voltar = "Voltar";
	static final String marcadorOuAlvo = "Marcador ou Alvo";
